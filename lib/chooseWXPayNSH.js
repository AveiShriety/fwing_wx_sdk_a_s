...
!(function (n) {
    ...
    return (postbody, successFn, requesturl) => {
        ...
        return index.wx.ready(function () {
            fetch(index.contextPath(requesturl) + "/rest/jssdk/chooseWXPayNSH/" + JSON.parse(localStorage.getItem("user")).openid, {
                method: "POST",
                headers: {
                ...
                if (execcode == 1) {
                    ...
                    index.wx.chooseWXPay({
                        ...
                        fail: function () {
                            ...
                            fetch(index.contextPath(requesturl) + "/rest/jssdk/chooseWXPayNSHCancelOrFail/" + JSON.parse(localStorage.getItem("user")).openid
